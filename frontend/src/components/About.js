                    ...
                    <div className="col s12 m6">
                        <div className="card card-flat">
                            <div className="card-image">
                                <img src={url + "/FelipePinto2.JPG"} alt="Felipe Matheus Pinto"/>
                            </div>
                            <div className="card-content">
                                ...
                                <li className="inline"><a href="https://medium.com/@felipempfreelancer" target="_blank"><img src={process.env.PUBLIC_URL + "/medium-logo.png"} width="25" height="25"/></a></li>
                                <li className="inline"><a href="https://felipemp.com" target="_blank"><i className='material-icons black-text'>person</i></a></li>
                            </div>
                        </div>
                    </div>
