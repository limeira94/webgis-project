...
urlpatterns = [
    ...
    path(
        'api/main/upload/',
        views.GeoJSONFileUploadAPIView.as_view(),
        name='upload_geojson_api',
    ),
    path(
        'api/main/geojson/<int:pk>/',
        views.GeoJSONDetailView.as_view(),
        name='get_geojson',
    ),
    path(
        'api/main/geojson/',
        views.GeoJSONListView.as_view(),
        name='get_all_geojson',
    ),
    ...
    path(
        'api/main/vector/geojson',
        views.ExportGeoJSON.as_view(),
        name='get_vector_geojson',
    ),
    path(
        'api/main/projects/', views.ProjectList.as_view(), name='get_projects'
    ),
    ...
    path(
        'api/main/token/refresh/',
        TokenRefreshView.as_view(),
        name='token_refresh',
    ),
    path(
        'api/main/token/verify/',
